...
-- Generation Time: Dec 30, 2022 at 04:44 AM
...
CREATE TABLE `Transactions` (
  ...
  `transactioncategory` varchar(50) NOT NULL,
  `transactionnote` varchar(300) NOT NULL
...
--
ALTER TABLE `expenses`
  MODIFY `expense_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
