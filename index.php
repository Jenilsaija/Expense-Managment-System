...
$transaction = mysqli_query($con, "SELECT SUM(Transaction) FROM Transactions WHERE user_id = '$userid'");
$expense = mysqli_query($con, "SELECT SUM(expense) FROM expenses WHERE user_id = '$userid'");
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col text-center">
                    <a href="add_transaction.php"><img src="icon/addex.png" width="57px" />
                      <p>Add Transaction</p>
                    </a>
                  </div>
                  <div class="col text-center">
        ...
        <h3 class="mt-4">Total of Expense</h3>
        <div class="row">
          <div class="col-md col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                 <h5 class="text-center"><?php $b = mysqli_fetch_array($expense); echo $b['SUM(expense)']." Rs";?></h5>
              </div>
            </div>
          </div>
          <div class="col-md col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                 <h5 class="text-center"><?php $c = mysqli_fetch_array($transaction); echo $c['SUM(Transaction)']." Rs";?></h5>
              </div>
            </div>
          </div>
          <div class="col-md col-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Total Amount of Expense</h5>
              </div>
              <div class="card-body">
                <h5 class="text-center"><?php $sum=(int)$b['SUM(expense)']+(int)$c['SUM(Transaction)']; echo $sum." Rs";?></h5>
              </div>
            </div>
          </div>
        </div>
