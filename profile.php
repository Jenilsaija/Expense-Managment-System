                ...
                <div class="row justify-content-center">
                    ...
                    <hr>
                        ...
                        <div class="container-fluid mb-4">
                            <h3 class="mt-4 text-center">Bakup Data</h3>
                            <br/>
                            <h5>You Want to Bakup all Records ?</h5>
                            <a href="./generatefile.php?uid=<?php echo $userid?>" id="btnfilegenerate" class="btn btn-primary my-2" >Generate File</a>
                            <a href="./downloadbakup.php" id="btnbakup" target="_blank"class="btn btn-primary my-2" <?php if($_SESSION["message-bakup"]==""){echo "hidden";}?> >Download</a>
                            <br/><h4 class="text-success" id="bakup"><?php echo $_SESSION["message-bakup"]; $_SESSION["message-bakup"]="";?></h4>
                        </div>
                        <br/>
                        <hr/>
                        <div class="container-fluid mb-4">
                            <h3 class="mt-4 text-center">Delete Data</h3>
                            <br/>
                            <h5>You Want to Delete all Records ?</h5>
                            <a  id="btndeleteall" class="btn btn-danger my-2" href="./deleteallrec.php" onclick="return confirm('Are you sure you want to Delete?')">Delete All Records</a>
                            <br/><h4 class="text-danger" id="warn"><?php echo $_SESSION["message"]; $_SESSION["message"]="";?></h4>
                        </div>
