...
if (isset($_POST['add'])) {
    ...
    $expenses = "INSERT INTO expenses (user_id, expense,expensedate,expensecategory,expensenote) VALUES ('$userid', '$expenseamount','$expensedate','$expensecategory','$expensenote')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE expenses SET expense='$expenseamount', expensedate='$expensedate', expensecategory='$expensecategory',expensenote='$expensenote' WHERE user_id='$userid' AND expense_id='$id'";
...
<head>
    ...
    <title>Add Expenses - D.E.M.S.</title>
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control col-sm-12" value="<?php echo $expensenote; ?>" id="expensenote" name="expensenote" required>
                                </div>
                            </div>
                            <div class="form-group row">
